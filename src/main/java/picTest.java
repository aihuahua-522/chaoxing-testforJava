...
//        FileInputStream inputStream = new FileInputStream("20200317144116342.jpg");
        ...
        String tokenResult = Jsoup.connect(getTokenUrl).method(org.jsoup.Connection.Method.GET).cookies(stringStringHashMap).execute().body();
...
//        hashMap.put("_token","6e580ee9878115521398035f530c4155");
